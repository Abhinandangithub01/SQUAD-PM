  ...
  return (
    <div className="h-full flex flex-col p-6">
      ...
      <div className="flex-1 overflow-x-auto">
        <div className="flex space-x-6 h-full pb-6" style={{ minWidth: 'max-content' }}>
          {kanbanData.columns.map((column) => (
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 border-b border-gray-200 cursor-move hover:bg-gray-100 transition-colors rounded-t-lg">
                <div className="flex items-center space-x-2">
              ...
              <div
                className={`flex-1 p-4 space-y-3 overflow-y-auto ${
                  draggedTask && dragOverColumn === column.id ? 'bg-primary-50 border-2 border-dashed border-primary-300' : ''
                }`}
